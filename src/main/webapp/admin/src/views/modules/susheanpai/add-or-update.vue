<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="安排床号" prop="anpaichuanghao">
          <el-input v-model="ruleForm.anpaichuanghao" 
              placeholder="安排床号" clearable  :readonly="ro.anpaichuanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="安排床号" prop="anpaichuanghao">
              <el-input v-model="ruleForm.anpaichuanghao" 
                placeholder="安排床号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
