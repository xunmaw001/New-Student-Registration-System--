<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="剩余床位" prop="shengyuchuangwei">
          <el-input v-model="ruleForm.shengyuchuangwei" 
              placeholder="剩余床位" clearable  :readonly="ro.shengyuchuangwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="剩余床位" prop="shengyuchuangwei">
              <el-input v-model="ruleForm.shengyuchuangwei" 
                placeholder="剩余床位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="床位号" prop="chuangweihao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="床位号"
                  v-model="ruleForm.chuangweihao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chuangweihao" label="床位号" prop="chuangweihao">
                    <span>{{ruleForm.chuangweihao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="未住床位" prop="weizhuchuangwei">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="未住床位"
                  v-model="ruleForm.weizhuchuangwei" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weizhuchuangwei" label="未住床位" prop="weizhuchuangwei">
                    <span>{{ruleForm.weizhuchuangwei}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	weizhuchuangwei : false,
      ...
      rules: {
          ...
          shengyuchuangwei: [
                { required: true, message: '剩余床位不能为空', trigger: 'blur' },
