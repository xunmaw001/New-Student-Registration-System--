<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="录取时间" prop="luqushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.luqushijian" 
                type="datetime"
                :readonly="ro.luqushijian"
                placeholder="录取时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.luqushijian" label="录取时间" prop="luqushijian">
...
export default {
  ...
  created() {
	this.ruleForm.luqushijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuanye = true;
          ...
          if(o=='luqushijian'){
            this.ruleForm.luqushijian = obj[o];
	    this.ro.luqushijian = true;
            continue;
          }
        }
      }
