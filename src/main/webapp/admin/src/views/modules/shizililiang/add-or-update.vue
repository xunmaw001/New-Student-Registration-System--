<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学时间" prop="jiaoxueshijian">
          <el-input v-model="ruleForm.jiaoxueshijian" 
              placeholder="教学时间" clearable  :readonly="ro.jiaoxueshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学时间" prop="jiaoxueshijian">
              <el-input v-model="ruleForm.jiaoxueshijian" 
                placeholder="教学时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="个人事迹" prop="gerenshiji">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gerenshiji" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gerenshiji" label="个人事迹" prop="gerenshiji">
                    <span v-html="ruleForm.gerenshiji"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueli = true;
          ...
          if(o=='jiaoxueshijian'){
            this.ruleForm.jiaoxueshijian = obj[o];
	    this.ro.jiaoxueshijian = true;
            continue;
          }
          if(o=='gerenshiji'){
	...
	this.ruleForm.gerenshiji = this.ruleForm.gerenshiji.replace(reg,'../../../ssm737jq/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shizililiang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shizililiangCrossAddOrUpdateFlag = false;
						 this.parent.search();
