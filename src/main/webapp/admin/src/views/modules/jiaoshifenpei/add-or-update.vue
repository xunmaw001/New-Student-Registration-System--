<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学楼名称" prop="jiaoxueloumingcheng">
          <el-input v-model="ruleForm.jiaoxueloumingcheng" 
              placeholder="教学楼名称" clearable  :readonly="ro.jiaoxueloumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学楼名称" prop="jiaoxueloumingcheng">
              <el-input v-model="ruleForm.jiaoxueloumingcheng" 
                placeholder="教学楼名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教室号" prop="jiaoshihao">
          <el-input v-model="ruleForm.jiaoshihao" 
              placeholder="教室号" clearable  :readonly="ro.jiaoshihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教室号" prop="jiaoshihao">
              <el-input v-model="ruleForm.jiaoshihao" 
                placeholder="教室号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jiaoxueloumingcheng'){
            this.ruleForm.jiaoxueloumingcheng = obj[o];
	    this.ro.jiaoxueloumingcheng = true;
            continue;
          }
          if(o=='jiaoshihao'){
            this.ruleForm.jiaoshihao = obj[o];
	    this.ro.jiaoshihao = true;
            continue;
          }
          if(o=='zuoweihao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaoshifenpei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaoshifenpeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
