    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="签到内容" prop="qiandaoneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="签到内容"
                  v-model="ruleForm.qiandaoneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiandaoneirong" label="签到内容" prop="qiandaoneirong">
                    <span>{{ruleForm.qiandaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
